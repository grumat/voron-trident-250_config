...
parser.add_argument('--data-file', default='./probe_accuracy.json')
parser.add_argument('--chart-file', default='./probe_accuracy.html')
...
PROBE_RE = re.compile(r'^// probe: at [\d.,]+[\s\w]+z=(?P<z>[0-9.-]+)')
